...
option_list <- list(
  ...
  make_option(c("-l", "--truncLen"), type="integer", default=NULL,
            help="length for R2 (required)." , metavar="path"),
...
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs, truncLen=c(250,truncLen.value), trimLeft=c(trimleft.value,5),
