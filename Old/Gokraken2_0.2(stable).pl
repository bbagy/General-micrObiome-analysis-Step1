...
foreach my $sample ( keys %s2f )	{
    ...
    if($paired == 1){
        ...
        my $out_class1 = "kraken2/$out_dir_classified" . "/" . $sample . "_classified_1.fastq";
        my $out_class2 = "kraken2/$out_dir_classified" . "/" . $sample . "_classified_2.fastq";
        my $out_unclass1 = "kraken2/$out_dir_unclassified" . "/" . $sample . "_unclassified_1.fastq";
        my $out_unclass2 = "kraken2/$out_dir_unclassified" . "/" . $sample . "_unclassified_2.fastq";
