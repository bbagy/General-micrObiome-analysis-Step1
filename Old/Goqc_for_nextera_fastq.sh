...
DB=(/media/uhlemannlab/6bcc25c9-efd7-4cc5-ad7e-98ca99596cf41/heekuk/DB/human_index/GRCh38/GRCh38)
...
do
cat QC/filtered_fastq/${i}_L001_R1_filtered.fastq.gz QC/filtered_fastq/${i}_L002_R1_filtered.fastq.gz QC/filtered_fastq/${i}_L001_R3_filtered.fastq.gz QC/filtered_fastq/${i}_L004_R1_filtered.fastq.gz > QC/merged_fastq/${i}_merged.fastq.gz
