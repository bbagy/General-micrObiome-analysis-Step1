...
set.seed(100)
errF <- learnErrors(filtFs, nreads=1000000, multithread=TRUE) # added option nreads=1000000
set.seed(100)
errR <- learnErrors(filtRs, nreads=1000000, multithread=TRUE) # added option nreads=1000000
