...
# for paired
#out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs, truncLen=c(250,50), trimLeft=c(trimleft.value,5),
#                     maxEE=c(2,2), truncQ=2, rm.phix=TRUE, compress=TRUE, # maxN=0,
#                     multithread=T, verbose=TRUE, matchIDs=TRUE)

# for single
#out <- filterAndTrim(fnFs, filtFs, truncLen=c(250), trimLeft=c(5),
#                     maxEE=c(2), truncQ=2, rm.phix=TRUE, compress=TRUE,  maxN=0,
#                     multithread=F, verbose=TRUE, matchIDs=TRUE)
